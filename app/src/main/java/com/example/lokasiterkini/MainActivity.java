package com.example.lokasiterkini;
                        ...
                        public void onSuccess(Location location) {
                            if (location != null){
                                try {
                                    ...
                                    address.setText("Alamat: "+addresses.get(0).getAddressLine(0));
                                    city.setText("Kota: "+addresses.get(0).getSubAdminArea());
                                    country.setText("Negara: "+addresses.get(0).getCountryName());
                                } catch (IOException e) {
                                    e.printStackTrace();
                                }
                            }
